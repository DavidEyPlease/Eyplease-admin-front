...
export default function LayoutEditor({ backgrounds, initialLayouts, savingLayout, saveLayouts, logos = [] }: Props) {
        ...
        <div className="flex h-[calc(100vh-120px)] overflow-hidden rounded-xl border text-foreground">
            ...
            <aside className="w-67.5 shrink-0 overflow-y-auto border-r bg-card p-4">
                ...
                */}
                ...
                <Button variant="outline" size="sm" className="mt-2 w-full" text="+ Fila listado" onClick={addRow}></Button>
                    ...
                    >
                        <Layer>
                            ...
                            {zones.map((z) => z.type === "photo" ? (
                                ...
                                <TextNode key={z.id} z={z} scale={S} onSelect={toggleSelect} onDragStart={onDragStart} onDragMove={onDragMove} onDragEnd={onDragEnd} setRef={setRef} />
                            ) : (
