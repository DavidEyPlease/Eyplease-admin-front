...
/** La barra ⌘K del panel: ir a cualquier página (y a cada una de sus hijas) escribiendo su nombre. */
const CommandBar = () => {
    ...
    return (
        <>
            ...
            >
                ...
                <span className="min-w-0 flex-1 truncate text-left">Ir a…</span>
            ...
            <CommandDialog open={open} onOpenChange={setOpen} title="Ir a" description="Escribe el nombre de una página del panel" className="shell-drop top-[22%] translate-y-0 rounded-[22px] sm:max-w-[540px]">
                <CommandInput placeholder="Escribe una página: Clientes, Publicaciones, Finanzas…" />
                <CommandList className="max-h-[52vh]">
                    <CommandEmpty>No hay una página con ese nombre.</CommandEmpty>
